...
const NotFound = () => {
  return (
    <section className="relative overflow-hidden bg-powder">
      <HibiscusPetal className="pointer-events-none absolute -bottom-24 -left-24 hidden h-[420px] w-[420px] rotate-[18deg] text-stone/15 md:block" />
      <div className="relative mx-auto max-w-3xl px-6 py-32 lg:px-10 lg:py-40">
        ...
        <h1 className="mt-6 text-4xl leading-[1.1] sm:text-5xl lg:text-6xl">
          We couldn&apos;t find{' '}
          <em className="font-light italic text-stem">that page</em>.
        </h1>
        ...
        <ul className="mt-10 flex flex-wrap gap-x-8 gap-y-3 text-base">
          <li>
            <Link
              href="/"
              className="group inline-flex items-center gap-2 text-frond underline decoration-stone underline-offset-[6px] transition-colors hover:text-stem hover:decoration-stem"
            >
              Home
          ...
          <li>
            <Link
              href="/about"
              className="text-frond underline decoration-stone underline-offset-[6px] transition-colors hover:text-stem hover:decoration-stem"
            >
              About us
            </Link>
          </li>

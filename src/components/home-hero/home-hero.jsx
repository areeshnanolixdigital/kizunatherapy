...
const HomeHero = () => {
  return (
    ...
    >
      <HibiscusPetal
        className="pointer-events-none absolute -bottom-24 -left-24 hidden h-[420px] w-[420px] rotate-[18deg] text-stone/15 md:block"
      />
      <HibiscusPetal
        className="pointer-events-none absolute -top-20 -right-16 h-56 w-56 -rotate-[24deg] text-stone/15 md:hidden"
      />
        ...
        <div className="md:col-span-7 lg:col-span-7">
          ...
          <Reveal delay={80}>
            ...
            >
              ...
              <em className="font-light italic text-stem">bonds</em>, transforming lives.
            </h1>
          </Reveal>
          <Reveal delay={160}>
          ...
          <Reveal delay={240}>
            <div className="mt-10">
              <Link
                href="/#therapists"
                className="group inline-flex items-center gap-2 text-base text-frond underline decoration-stone underline-offset-[6px] transition-colors hover:text-stem hover:decoration-stem focus-visible:outline-none focus-visible:text-stem"
              >
                Meet our therapists
                <ArrowRight
                  aria-hidden="true"
